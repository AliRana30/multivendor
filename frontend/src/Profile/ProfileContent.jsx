...
const ReviewModal = ({ isOpen, onClose, product, onSubmit, reviewRating, setReviewRating, hoverRating, setHoverRating, reviewComment, setReviewComment, productLoading }) => {
...
const AllOrders = ({ orders, loading, isReviewed, handleWriteReview, RefundHandler, showReviewModal, setShowReviewModal, currentReviewProduct, setCurrentReviewProduct, reviewRating, setReviewRating, reviewComment, setReviewComment, hoverRating, setHoverRating, handleReviewSubmit, productLoading }) => {
  if (loading) {
    return (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-3">
              ...
              <p>
                ...
                <span
                  className={`ml-2 px-2 py-1 rounded-full text-xs font-medium ${order.orderStatus === "delivered"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mb-3 text-sm">
              ...
              <p>
                ...
                <span
                  className={`ml-1 ${order.paymentInfo?.paymentStatus === "paid"
                      ? "text-green-600"
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-3">
                ...
                <p>
                  ...
                  <span
                    className={`ml-2 px-2 py-1 rounded-full text-xs font-medium ${order.orderStatus === "refunded"
                        ? "bg-green-100 text-green-800"
                        : order.orderStatus === "Processing Refund"
                          ? "bg-yellow-100 text-yellow-800"
                          : order.orderStatus === "refund request"
  ...
  <div className="p-4 text-black">
    ...
    {option === "Orders" && (
      <AllOrders
        ...
        currentReviewProduct={currentReviewProduct}
        setCurrentReviewProduct={setCurrentReviewProduct}
        reviewRating={reviewRating}
        setReviewRating={setReviewRating}
        reviewComment={reviewComment}
        setReviewComment={setReviewComment}
