...
import { useNavigate } from "react-router-dom";
  ...
  const OrderSummary = ({ subtotal, appliedCoupon, discount, totalAmount }) => (
  ...
  const CartItems = ({ enhancedCart, getImageUrl }) => (
    <div className="mb-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
        ...
        {currentStep === "shipping" && (
          <div className="text-black">
            ...
            <CartItems enhancedCart={enhancedCart} getImageUrl={getImageUrl} />
