...
const ProductsCategory = () => {
  ...
  useEffect(() => {
    ...
    const filtered = products.filter((product) => {
      ...
      return product.category.toLowerCase() === formattedCategory.toLowerCase();
    });
              ...
              return (
                ...
                >
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    <button 
                      disabled={product.stock === 0}
                      className={`w-full font-semibold py-3 rounded-xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg flex items-center justify-center gap-2 ${
                        product.stock === 0
