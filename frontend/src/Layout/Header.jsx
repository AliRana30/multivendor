...
const Header = () => {
  ...
  // Search Component (reusable for mobile and desktop)
  const SearchComponent = ({ isMobile = false, onClose = null }) => (
    <div className={`relative ${isMobile ? 'w-full' : 'flex-1 max-w-3xl'}`}>
      <motion.div
        className={`relative transition-all duration-500 ease-out ${
          isSearchFocused && !isMobile ? "transform scale-105" : ""
        }`}
      >
        <div className={`relative ${
          isMobile 
            ...
            : `bg-white/80 backdrop-blur-sm rounded-2xl transition-all duration-300 ${
                isSearchFocused
                  ? "shadow-2xl ring-4 ring-blue-200/50 bg-white"
          ...
          <motion.div
            ...
            animate={{
              ...
              scale: isSearchFocused && !isMobile ? 1.1 : 1
            }}
          ...
          <input
            ...
            placeholder={isMobile ? "Search products..." : "Discover amazing products..."}
            className={`relative w-full ${
              isMobile 
                ? 'py-3 pl-10 pr-10 rounded-xl text-sm' 
                : 'py-3 sm:py-4 pl-12 sm:pl-14 pr-12 sm:pr-14 rounded-2xl text-sm sm:text-base'
          ...
          <AnimatePresence>
            {searchTerm && (
              <motion.button
                ...
                } top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-700 transition-all duration-200 p-1.5 rounded-full`}
              >
      ...
      <AnimatePresence>
        {searchData.length > 0 && (
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className={`absolute top-full left-0 right-0 mt-3 bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-100/50 overflow-hidden z-50 ${
          ...
          >
            ...
            <div className="relative overflow-y-auto custom-scrollbar h-full">
                  ...
                  return (
                    ...
                    >
                      <Link
                        ...
                        className="flex items-center p-3 sm:p-4 hover:bg-white/70 transition-all duration-300 rounded-2xl m-1 group border border-transparent hover:border-gray-100/50 hover:shadow-lg"
                        onClick={() => {
                          clearSearch();
                          onClose && onClose();
                        }}
                      >
                        ...
                        } bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl mr-3 sm:mr-4 flex-shrink-0 overflow-hidden group-hover:shadow-lg transition-shadow duration-300`}>
                          <img
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {isReduxProduct && (
                            <div className="flex items-center mt-1 sm:mt-2">
                              <span className={`text-xs px-2 sm:px-3 py-1 rounded-full font-semibold transition-all duration-200 ${
                                item.stock > 10 
                        ...
                        <div className="flex flex-col items-end flex-shrink-0 ml-2 sm:ml-4">
                          <div className={`text-indigo-600 font-bold ${
                            isMobile ? 'text-sm' : 'text-sm sm:text-lg'
                          }`}>
              ...
              {searchData.length >= 8 && (
                <div className="px-4 sm:px-6 py-4 bg-gradient-to-r from-gray-50/80 to-gray-100/80 text-center border-t border-gray-100/50">
      ...
      <AnimatePresence>
        {searchTerm.length > 0 && searchData.length === 0 && !isSearchFocused && (
          <motion.div
            ...
            className="absolute top-full left-0 right-0 mt-3 bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-100/50 p-6 sm:p-8 z-50"
          >
            <div className="text-center">
              <div className="mx-auto mb-4 w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl flex items-center justify-center">
                <FiSearch className="text-gray-400" size={isMobile ? 20 : 28} />
              </div>
              <h3 className={`${isMobile ? 'text-base' : 'text-lg'} font-bold text-gray-800 mb-2`}>No products found</h3>
              <p className="text-sm text-gray-600 mb-1">We couldn't find anything matching <span className="font-semibold text-indigo-600">"{searchTerm}"</span></p>
              <p className="text-xs text-gray-500">Try a different search term or browse our categories</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto py-3 sm:py-5 px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden lg:flex items-center justify-between gap-8">
            ...
            <div className="flex-shrink-0">
              <Link
                to="/create-shop"
                className="bg-black text-white px-6 sm:px-8 py-3 rounded-full font-semibold text-sm sm:text-base transition-all duration-300 flex items-center space-x-2 hover:bg-gray-800 shadow-lg"
              >
      ...
      <AnimatePresence>
        {mobileSearchOpen && (
          ...
          >
            <motion.div
              className="bg-white p-4 m-4 mt-20 rounded-2xl shadow-xl"
