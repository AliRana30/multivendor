        ...
        <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`w-full font-medium py-3 rounded-md transition-colors duration-200 tracking-wide ${
                isLoading ? "bg-gray-400 cursor-not-allowed opacity-60" : "bg-gray-900 hover:bg-gray-800"
              } text-white`}
            >
          ...
          <div className="mt-8 pt-6 border-t border-gray-100">
            <p className="text-gray-500 font-light text-sm text-center">
              ...
              <Link to="/create-shop" className="text-gray-900 font-medium hover:underline">
                Create Shop
              </Link>
            </p>
          </div>
