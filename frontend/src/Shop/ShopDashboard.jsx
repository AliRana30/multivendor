                  ...
                  {stats.pendingRevenue > 0 && (
                    <div className="mt-4 pt-4 border-t border-white/20">
                      <div className="flex justify-between items-center">
                        <span className="text-white/80 text-sm">Pending Revenue (after fees):</span>
                        <span className="text-white font-semibold">{formatCurrency(stats.pendingRevenue)}</span>
                      </div>
                      <p className="text-white/60 text-xs mt-1">From orders in processing/shipping (90% of order value)</p>
                    </div>
                  )}
                </div>
              </div>
