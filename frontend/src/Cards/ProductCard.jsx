...
const ProductCard = ({ product }) => {
  ...
  return (
    <>
      <div className="group relative bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden h-[470px]">
        ...
        {product.sold_out > 50 && (
          <div className="absolute bottom-3 left-3 z-10 bg-orange-500 text-white text-xs font-semibold px-2 py-1 rounded flex items-center gap-1">
            <span>🔥</span>
        ...
        <div className="absolute top-3 right-3 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
          <button onClick={handleWishlistToggle} className="bg-white p-2 rounded-full shadow-md hover:shadow-lg transition-shadow">
            {isInWishlist ? (
          ...
          <button onClick={() => setShowDetails(true)} className="bg-white p-2 rounded-full shadow-md hover:shadow-lg transition-shadow">
        ...
        <div className="p-4 space-y-3">
          ...
          <button 
            ...
            className={`w-full font-medium py-2.5 rounded-md transition-colors duration-200 flex items-center justify-center gap-2 ${
              product.stock === 0
